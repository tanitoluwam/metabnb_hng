  ...
  return (
    <div className="nft_section row py-5 mx-auto px-5">
      <div className="col-md-6 d-flex flex-column justify-content-center text-white opacity-100">
        ...
        <p className="nft_body">
          Discover our NFT gift cards collection. Loyal customers gets amazing
          gift cards which are traded as NFTs. These NFTs gives our cutomer
          access to loads of our exclusive services.
        </p>
        <Button style="btn details_btn bg-white w-50"> Learn more </Button>
      </div>
      <div className="col-6 w-50 parent-container d-none d-md-block d-lg-block d-xl-block">
